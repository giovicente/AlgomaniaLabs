...
import com.giovicente.right.triangle.OptimizedRightTriangle;
...
public class OptimizedRightTriangleTest {

    @Test
    public void shouldReturnCorrectRightTriangleOutput() {
        int maxNumberOfAsterisks = 32000;
        List<String> result = OptimizedRightTriangle.generateTriangle(maxNumberOfAsterisks);
    ...
    public void shouldReturnEmptyTriangle() {
        ...
        assertTrue(OptimizedRightTriangle.generateTriangle(maxNumberOfAsterisks).isEmpty());
    }
}
